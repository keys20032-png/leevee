    ...
    <div className="min-h-screen bg-background flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md space-y-8 text-center">
        ...
        <div className="inline-flex p-[2px] rounded-2xl mx-auto" style={{ background: "linear-gradient(135deg, hsl(var(--gradient-start)), hsl(var(--gradient-end)))" }}>
          <img src={logo} alt="SafeHubHelp logo" className="w-20 h-20 rounded-[14px] object-cover" />
        </div>
        ...
        <div className="space-y-3">
          ...
          <p className="text-muted-foreground text-sm leading-relaxed max-w-sm mx-auto">
            Add SafeHubHelp to your home screen for quick access to resources anytime you need them.
          </p>
        </div>
        ...
        {isInstalled ? (
          <div className="rounded-xl border border-primary/30 bg-primary/10 p-6 space-y-3">
            ...
            <p className="text-xs text-muted-foreground">
              SafeHubHelp is on your home screen. Open it anytime.
            </p>
          </div>
        ) : deferredPrompt ? (
          <button
